...
namespace Exercises
{
    public static class ElementAt
    {
        ...
        {
            Pet petIndex = pets.ElementAtOrDefault(index);

			return petIndex == null ?
				String.Format("Pet data is missing for index {0}", index) :
                String.Format("Pet name: {0}", pets.ElementAt(index).Name);
        }
